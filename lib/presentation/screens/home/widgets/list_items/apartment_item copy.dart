...
class ApartmentItem extends StatelessWidget {
  ApartmentItem({Key? key, required this.publicExpens}) : super(key: key);
        ...
        children: [
          Row(
            children: [
              ...
              GestureDetector(
                onTap: () => showApartmentActions(context),
                child: Container(
                  key: moreKey,
            ...
            child: StreamBuilder<List<CurrentDateExpense>>(
              ...
              builder: (context, snapshot) {
                return Text(
                  ...
                  style:
                      const TextStyle(fontWeight: FontWeight.w500, letterSpacing: 0.2, color: blue),
                  maxLines: 2,
                  overflow: TextOverflow.fade,
                );
              },
  ...
  void showApartmentActions(BuildContext context) {
    showDialog(
      context: context,
      builder: (_) => MyPopUpMenu(
        moreIconRectCordinates: moreKey.globalPaintBounds,
        popUpItems: [
          MyPopUpMenuItem(
